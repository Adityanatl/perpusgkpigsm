...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { field: "sistem_belajar_name", label: "Sistem Belajar Name"},
        { field: "tingkat_sulit_name", label: "Tingkat Sulit Name" },
  ...
  computed: {
    tableData: function() {
      return (this.$store.getters['strategic/strategics']) ? this.$store.getters['strategic/strategics'] : []
    },
    rows: function() {
      return (this.$store.getters['strategic/paginate'].total) ? this.$store.getters['strategic/paginate'].total : 0
    },
  ...
  mounted() {
    ...
    this.$store.dispatch('strategic/GET_STRATEGICS',{masterType: this.$route.meta.name,params:paramsTemp}).then(()=>{
  ...
  methods: {
    ...
    async providerData(ctx, callback) {
      ...
      this.$store.dispatch(
              'strategic/GET_STRATEGICS',{masterType: this.$route.meta.name,params:paramsTemp}
      ).then(()=>{
    ...
    onPageChange(params) {
      ...
      this.$store.dispatch("strategic/GET_STRATEGICS", {
        params: paramsTemp,
    ...
    deleteMaster(masterId, name) {
        Swal.fire({
          ...
          if (result.value) {
            this.$store.dispatch('strategic/DELETE_STRATEGIC', masterId).then((resp) => {
    ...
    downloadMaster(masterId) {
      ...
      this.$store.dispatch('strategic/DOWNLOAD_STRATEGIC', masterId)
    ...
    editMaster(masterId){
      this.$router.push('/strategic/edit/'+masterId)
    },
  ...
  <Layout>
    ...
    <div class="col-sm-12">
      <div class="text-sm-right">
        <router-link tag="a" to="/strategic/add" class="btn btn-success">
