                ...
                <div class="col-lg-6">
                    <div class="banner-content-1 cl-white">
                        ...
                        <div class="banner-button-group">
                            <a href="#0" class="button-4">UNDUH GRATIS</a>
                            <a href="#0" class="button-4 active">JELAJAHI FITUR</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                        ...
                        <div class="row justify-content-center mb-30-none">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="am-item active">
                                    ...
                                    <div class="am-content">
                                        <h5 class="title">Solusi Administrasi</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
    ...
    <section class="how-section padding-bottom padding-top" id="how">
        <div class="container">
            <div class="section-header">
                ...
                <p>Mengajar dengan Cerdas, berAzas, Ringkas dan Antusias. Karena kamu adalah Guru Efisien yang efektif</p>
            </div>
            <div class="row justify-content-xl-between justify-content-center mb-40-none">
                <div class="col-lg-4 col-sm-6 col-xl-3">
                    <div class="how-item">
                        ...
                        <div class="how-content">
                            <a href="#0" class="button-3 active">Download Aplikasi</a>
                ...
                <div class="col-lg-4 col-sm-6 col-xl-3">
                    <div class="how-item">
                        ...
                        <div class="how-content">
                            <a href="#0" class="button-3">BUAT AKUN</a>
                ...
                <div class="col-lg-4 col-sm-6 col-xl-3">
                    <div class="how-item">
                        ...
                        <div class="how-content">
                            <a href="#0" class="button-3">SAATNYA BERKREASI</a>
                ...
                <div class="pricing-range">
                    ...
                    <div class="text-center mt-3">
                        <div class="right mb-4">
                            <a href="#0" class="custom-button mb-3">DAFTAR SEKARANG!</a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="section-header left-style coverage-header">
                        <h5 class="cate">Tersebar hampir di semua daerah terluar di Indonesia</h5>
                        <h2 class="title">Begitu dekat dan bersahabat</h2>
                        <p>
                            Kami sangat peduli atas hidup setiap insan dan bagaimana mereka berproses dalam keunikan keberadaan mereka
                        </p>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="coverage-right-area text-lg-right">
                        ...
                        <p>Daerah 3T</p>
                        <a href="#0">(Tertinggal, Terdepan, Terluar)</i></a>
                    </div>
                </div>
            </div>
