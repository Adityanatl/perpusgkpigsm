  ...
  export default {
    ...
    data() {
      return {
        ...
        dropzoneLogoOptions: {
          url: window.axios.defaults.baseURL + 'api/files/upload',
          maxFilesize: 1,
          maxFiles: 1,
          addRemoveLinks: true,
          paramName: "image",
    ...
    computed: {
      tableData: function() {
        return (this.$store.getters['files/files']) ? this.$store.getters['files/files'] : []
      },
      rows: function() {
    ...
    mounted() {
      ...
      this.$store.dispatch('files/GET_FILES',{masterType: this.$route.meta.name,params:paramsTemp}).then(()=>{
    ...
    methods: {
      ...
      async providerData(ctx, callback) {
        ...
        this.$store.dispatch(
                'files/GET_FILES',{masterType: this.$route.meta.name,params:paramsTemp}
        ).then(()=>{
      ...
      onPageChange(params) {
        ...
        this.$store.dispatch("files/GET_FILES", {
          params: paramsTemp,
      ...
      deleteMaster(masterId, name) {
        Swal.fire({
          ...
          if (result.value) {
            this.$store.dispatch('files/DELETE_SILABUS', masterId).then((resp) => {
      ...
      downloadMaster(masterId) {
        ...
        this.$store.dispatch('files/DOWNLOAD_SILABUS', masterId)
      ...
      dropzoneLogoSuccess: function(file, response) {
        ...
        // this.profileLogo = response.data.url;
        // this.initData()
            ...
            <div class="table-responsive mb-0">
              ...
              >
                <template slot="table-row" slot-scope="props">
                  ...
                  <div v-else-if="props.column.field == 'btn'">
