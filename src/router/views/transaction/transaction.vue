                    ...
                    >
                      ...
                      <div>
                        <p style="font-size:1.1em"><b>
                            {{transaction.product_name}} : <span>IDR</span>{{transaction.gross_amount.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}}
                        </b></p><br>
                      </div>
                      <div>
                        <p style="font-size:1em; color:#373334">
                            Subtotal : <span>IDR</span>{{transaction.gross_amount.toFixed(2).replace(/\d(?=(\d{3})+.)/g, '$&,')}}
                        </p>
                      </div><br><br>
                      <div class="text-center">
                        <p style="font-size:1em;">
